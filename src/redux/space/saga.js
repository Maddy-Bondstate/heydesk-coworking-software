...
const addLocationRequest = async (name,unique_code,description,address,city,country,zip,state,image,start_time,end_time,time_zone,
  is_open) => {
...
function* addLocationItems({ payload }) {
 //console.log('floor',payload.state); 
 const {name,unique_code,description,address,city,country,zip,state} = payload.location;
 const { image } = payload.image;
 ...
 try {
   const addLocation = yield call (addLocationRequest,name,unique_code,description,address,city,country,zip,state,image,
